...
- Retention policy and orchestration remain provider-independent. The local foundation supplies the model, migration, cutoff policy, privileged application use case, UI states, and tests without browser-triggered cleanup or a public purge action. Automatic server scheduling and Appwrite Storage deletion remain Phase 13 work.
