...
- Household deletion preserves Expenses (including soft-deleted), all terminal Settlements, Receipt metadata/Blobs, private Cards, private historical Expense Card snapshots, User Profiles, existing audits, and the tombstoned House Code. Cards remain independent and usable.
