...
const PINNED_SHA256: Readonly<Record<string, string>> = Object.freeze({
  ...
  "small.webp": "7e74e6e307fc3dedeef1c33d61124413d7c3f20068170e940a307f01897cdaa7",
  ...
  "receipt-truncated.png": "d86db71bbd7701a15eee86f8903618156d7e9828a8c1a2d12101ec98052f4e23",
...
const fixtures: readonly Fixture[] = [
  ...
  { filename: "receipt-truncated.png", mimeType: "image/png", bytes: png.subarray(0, png.byteLength - 5), expectation: "reject-malformed" },
...
for (const fixture of fixtures) {
  ...
  if (fixture.expectation !== "reject-malformed") {
    const metadata = await sharp(Buffer.from(fixture.bytes), { failOn: "error", sequentialRead: true }).metadata();
